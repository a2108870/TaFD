...
all_filters = ['ExposureFilter', 'GammaFilter', 'SaturationFilter', 'WBFilter', 'ContrastFilter', 'BNWFilter',
...
def UAA_atk(input, y, model, device, lr=0.01, max_iterations=10, steps=64, bound=16, ncls=10,
