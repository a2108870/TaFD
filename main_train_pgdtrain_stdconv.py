...
# 整合模型（stdconv 分支消融版本）
from models.encoder_stdconv import create_encoder
...
if __name__ == "__main__":
    ...
    if not args.result_dir:
        args.result_dir = (
            f"./results/tafd_pgdtrain_apgdtest_stdconv_{args.backbone}_{args.dataset}_d{args.domains}"
    ...
    print("[Ablation] FC-Conv drops spectral decomposition and uses K spatial conv branches with hard domain selection.")
