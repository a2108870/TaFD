# -*- coding: utf-8 -*-
"""
FCConv (Frequency-Conditional Convolution) module.

- rFFT-based spectral masking on Zernike basis
- Concentric-ring initialization via Zernike R2^0 + per-expert bias
- Hard routing: num_domains == num_experts, sample-level expert selection

Usage: from models.fdconv import FCConv
"""
...
class FCConv(nn.Module):
    """
    Frequency-Conditional Convolution (FCConv) with hard routing.
