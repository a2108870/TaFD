"""FC-Conv used by the ablation without Hungarian alignment.

The convolution itself matches the complete TaFD model. The corresponding
training pipeline removes Hungarian alignment when updating the mapping from
attack sources to threat domains.
"""
