# -*- coding: utf-8 -*-
"""TaFD ablation without basis-parameterized spectral masks."""
...
from models.frequency_conditional_convolution_without_basis_parameterized_mask import FrequencyConditionalConvolution
