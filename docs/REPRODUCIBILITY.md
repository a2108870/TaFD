...
needed by the TaFD scripts. It does not include third-party baseline training
code, datasets, paper result archives, or checkpoints.

## Default Paper Configuration

- Threat domains: K=2
- Backbones: ResNet and MobileViT
- Datasets: CIFAR-10, CIFAR-100, Tiny-ImageNet-style 32x32 splits, and
  Imagenette
...
paths. CIFAR datasets can be downloaded automatically by torchvision. Tiny and
Imagenette folders must already exist under the dataset root.
