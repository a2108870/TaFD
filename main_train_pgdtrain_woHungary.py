...
# 整合模型（去掉 Hungarian 时序对齐的消融版本）
from models.encoder_woHungary import create_encoder
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Unified-LR Adversarial Training + PGD-Train APGD-Test + Fixed BPDA-T (woHungary)")
    ...
    if not args.result_dir:
        args.result_dir = (
            f"./results/tafd_pgdtrain_apgdtest_woHungary_{args.backbone}_{args.dataset}_d{args.domains}"
    ...
    print("[Ablation] Threat-domain clustering keeps raw KMeans labels without Hungarian alignment.")
